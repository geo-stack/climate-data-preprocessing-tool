...
from qtpy.QtCore import Qt, QThread, QObject, Signal, QEvent
from qtpy.QtWidgets import (QApplication, QDesktopWidget, QWidget, QMenu,
...
# from climate-data-extraction-tool.common import StyleDB
...
class DwnldWeatherWidget(QWidget):
    ...
    ConsoleSignal = Signal(str)
    sig_download_process_ended = Signal()
...
class RawDataDownloader(QObject):
    ...
    sig_download_finished = Signal(list)
    sig_update_pbar = Signal(int)
    ConsoleSignal = Signal(str)
